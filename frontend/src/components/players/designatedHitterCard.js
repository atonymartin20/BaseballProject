...
class DesignatedHitterCard extends React.Component {
    ...
    componentDidMount() {
        const foundIndex = this.context.state.designatedHitters.findIndex(x => x.id === this.props.id);
        this.setState({
            firstName: this.context.state.designatedHitters[foundIndex].firstName,
            lastName: this.context.state.designatedHitters[foundIndex].lastName,
            birthday: this.context.state.designatedHitters[foundIndex].birthday,
            bats: this.context.state.designatedHitters[foundIndex].bats,
            throws: this.context.state.designatedHitters[foundIndex].throws,
            currentTeam: this.context.state.designatedHitters[foundIndex].currentTeam,
            imageURL: this.context.state.designatedHitters[foundIndex].imageURL,
            primaryPosition: this.context.state.designatedHitters[foundIndex].primaryPosition,
            otherPositions: this.context.state.designatedHitters[foundIndex].otherPositions,
            GamesPlayed2017: this.context.state.designatedHitters[foundIndex].GamesPlayed2017,
            BA2017: this.context.state.designatedHitters[foundIndex].BA2017,
            OBP2017: this.context.state.designatedHitters[foundIndex].OBP2017,
            SLG2017: this.context.state.designatedHitters[foundIndex].SLG2017,
            PA2017: this.context.state.designatedHitters[foundIndex].PA2017,
            Doubles2017: this.context.state.designatedHitters[foundIndex].Doubles2017,
            HR2017: this.context.state.designatedHitters[foundIndex].HR2017,
            Runs2017: this.context.state.designatedHitters[foundIndex].Runs2017,
            RBI2017: this.context.state.designatedHitters[foundIndex].RBI2017,
            LineupSlot2017: this.context.state.designatedHitters[foundIndex].LineupSlot2017,
            GBPercent2017: this.context.state.designatedHitters[foundIndex].GBPercent2017,
            LDPercent2017: this.context.state.designatedHitters[foundIndex].LDPercent2017,
            FBPercent2017: this.context.state.designatedHitters[foundIndex].FBPercent2017,
            PullPercent2017: this.context.state.designatedHitters[foundIndex].PullPercent2017,
            CenterPercent2017: this.context.state.designatedHitters[foundIndex].CenterPercent2017,
            OppoPercent2017: this.context.state.designatedHitters[foundIndex].OppoPercent2017,
            HRPerFB2017: this.context.state.designatedHitters[foundIndex].HRPerFB2017,
            HardHitPercent2017: this.context.state.designatedHitters[foundIndex].HardHitPercent2017,
            ExitVelo2017: this.context.state.designatedHitters[foundIndex].ExitVelo2017,
            FlyBallLineDriveExitVelo2017: this.context.state.designatedHitters[foundIndex].FlyBallLineDriveExitVelo2017,
            LaunchAngle2017: this.context.state.designatedHitters[foundIndex].LaunchAngle2017,
            BarrelPercent2017: this.context.state.designatedHitters[foundIndex].BarrelPercent2017,
            BABIP2017: this.context.state.designatedHitters[foundIndex].BABIP2017,
            WOBA2017: this.context.state.designatedHitters[foundIndex].WOBA2017,
            xWOBA2017: this.context.state.designatedHitters[foundIndex].xWOBA2017,
            xBA2017: this.context.state.designatedHitters[foundIndex].xBA2017,
            AvgHRDistance2017: this.context.state.designatedHitters[foundIndex].AvgHRDistance2017,
            WRCPlus2017: this.context.state.designatedHitters[foundIndex].WRCPlus2017,
            OPSPlus2017: this.context.state.designatedHitters[foundIndex].OPSPlus2017,
            BBPercent2017: this.context.state.designatedHitters[foundIndex].BBPercent2017,
            KPercent2017: this.context.state.designatedHitters[foundIndex].KPercent2017,
            ChaseRate2017: this.context.state.designatedHitters[foundIndex].ChaseRate2017,
            ContactPercent2017: this.context.state.designatedHitters[foundIndex].ContactPercent2017,
            SprintSpeed2017: this.context.state.designatedHitters[foundIndex].SprintSpeed2017,
            StolenBases2017: this.context.state.designatedHitters[foundIndex].StolenBases2017,
            StolenBasePercent2017: this.context.state.designatedHitters[foundIndex].StolenBasePercent2017,
            FWAR2017: this.context.state.designatedHitters[foundIndex].FWAR2017,
            GamesPlayed2018: this.context.state.designatedHitters[foundIndex].GamesPlayed2018,
            BA2018: this.context.state.designatedHitters[foundIndex].BA2018,
            OBP2018: this.context.state.designatedHitters[foundIndex].OBP2018,
            SLG2018: this.context.state.designatedHitters[foundIndex].SLG2018,
            PA2018: this.context.state.designatedHitters[foundIndex].PA2018,
            Doubles2018: this.context.state.designatedHitters[foundIndex].Doubles2018,
            HR2018: this.context.state.designatedHitters[foundIndex].HR2018,
            Runs2018: this.context.state.designatedHitters[foundIndex].Runs2018,
            RBI2018: this.context.state.designatedHitters[foundIndex].RBI2018,
            LineupSlot2018: this.context.state.designatedHitters[foundIndex].LineupSlot2018,
            GBPercent2018: this.context.state.designatedHitters[foundIndex].GBPercent2018,
            LDPercent2018: this.context.state.designatedHitters[foundIndex].LDPercent2018,
            FBPercent2018: this.context.state.designatedHitters[foundIndex].FBPercent2018,
            PullPercent2018: this.context.state.designatedHitters[foundIndex].PullPercent2018,
            CenterPercent2018: this.context.state.designatedHitters[foundIndex].CenterPercent2018,
            OppoPercent2018: this.context.state.designatedHitters[foundIndex].OppoPercent2018,
            HRPerFB2018: this.context.state.designatedHitters[foundIndex].HRPerFB2018,
            HardHitPercent2018: this.context.state.designatedHitters[foundIndex].HardHitPercent2018,
            ExitVelo2018: this.context.state.designatedHitters[foundIndex].ExitVelo2018,
            FlyBallLineDriveExitVelo2018: this.context.state.designatedHitters[foundIndex].FlyBallLineDriveExitVelo2018,
            LaunchAngle2018: this.context.state.designatedHitters[foundIndex].LaunchAngle2018,
            BarrelPercent2018: this.context.state.designatedHitters[foundIndex].BarrelPercent2018,
            BABIP2018: this.context.state.designatedHitters[foundIndex].BABIP2018,
            WOBA2018: this.context.state.designatedHitters[foundIndex].WOBA2018,
            xWOBA2018: this.context.state.designatedHitters[foundIndex].xWOBA2018,
            xBA2018: this.context.state.designatedHitters[foundIndex].xBA2018,
            AvgHRDistance2018: this.context.state.designatedHitters[foundIndex].AvgHRDistance2018,
            WRCPlus2018: this.context.state.designatedHitters[foundIndex].WRCPlus2018,
            OPSPlus2018: this.context.state.designatedHitters[foundIndex].OPSPlus2018,
            BBPercent2018: this.context.state.designatedHitters[foundIndex].BBPercent2018,
            KPercent2018: this.context.state.designatedHitters[foundIndex].KPercent2018,
            ChaseRate2018: this.context.state.designatedHitters[foundIndex].ChaseRate2018,
            ContactPercent2018: this.context.state.designatedHitters[foundIndex].ContactPercent2018,
            SprintSpeed2018: this.context.state.designatedHitters[foundIndex].SprintSpeed2018,
            StolenBases2018: this.context.state.designatedHitters[foundIndex].StolenBases2018,
            StolenBasePercent2018: this.context.state.designatedHitters[foundIndex].StolenBasePercent2018,
            FWAR2018: this.context.state.designatedHitters[foundIndex].FWAR2018,
            GamesPlayed2019: this.context.state.designatedHitters[foundIndex].GamesPlayed2019,
            BA2019: this.context.state.designatedHitters[foundIndex].BA2019,
            OBP2019: this.context.state.designatedHitters[foundIndex].OBP2019,
            SLG2019: this.context.state.designatedHitters[foundIndex].SLG2019,
            PA2019: this.context.state.designatedHitters[foundIndex].PA2019,
            Doubles2019: this.context.state.designatedHitters[foundIndex].Doubles2019,
            HR2019: this.context.state.designatedHitters[foundIndex].HR2019,
            Runs2019: this.context.state.designatedHitters[foundIndex].Runs2019,
            RBI2019: this.context.state.designatedHitters[foundIndex].RBI2019,
            LineupSlot2019: this.context.state.designatedHitters[foundIndex].LineupSlot2019,
            GBPercent2019: this.context.state.designatedHitters[foundIndex].GBPercent2019,
            LDPercent2019: this.context.state.designatedHitters[foundIndex].LDPercent2019,
            FBPercent2019: this.context.state.designatedHitters[foundIndex].FBPercent2019,
            PullPercent2019: this.context.state.designatedHitters[foundIndex].PullPercent2019,
            CenterPercent2019: this.context.state.designatedHitters[foundIndex].CenterPercent2019,
            OppoPercent2019: this.context.state.designatedHitters[foundIndex].OppoPercent2019,
            HRPerFB2019: this.context.state.designatedHitters[foundIndex].HRPerFB2019,
            HardHitPercent2019: this.context.state.designatedHitters[foundIndex].HardHitPercent2019,
            ExitVelo2019: this.context.state.designatedHitters[foundIndex].ExitVelo2019,
            FlyBallLineDriveExitVelo2019: this.context.state.designatedHitters[foundIndex].FlyBallLineDriveExitVelo2019,
            LaunchAngle2019: this.context.state.designatedHitters[foundIndex].LaunchAngle2019,
            BarrelPercent2019: this.context.state.designatedHitters[foundIndex].BarrelPercent2019,
            BABIP2019: this.context.state.designatedHitters[foundIndex].BABIP2019,
            WOBA2019: this.context.state.designatedHitters[foundIndex].WOBA2019,
            xWOBA2019: this.context.state.designatedHitters[foundIndex].xWOBA2019,
            xBA2019: this.context.state.designatedHitters[foundIndex].xBA2019,
            AvgHRDistance2019: this.context.state.designatedHitters[foundIndex].AvgHRDistance2019,
            WRCPlus2019: this.context.state.designatedHitters[foundIndex].WRCPlus2019,
            OPSPlus2019: this.context.state.designatedHitters[foundIndex].OPSPlus2019,
            BBPercent2019: this.context.state.designatedHitters[foundIndex].BBPercent2019,
            KPercent2019: this.context.state.designatedHitters[foundIndex].KPercent2019,
            ChaseRate2019: this.context.state.designatedHitters[foundIndex].ChaseRate2019,
            ContactPercent2019: this.context.state.designatedHitters[foundIndex].ContactPercent2019,
            SprintSpeed2019: this.context.state.designatedHitters[foundIndex].SprintSpeed2019,
            StolenBases2019: this.context.state.designatedHitters[foundIndex].StolenBases2019,
            StolenBasePercent2019: this.context.state.designatedHitters[foundIndex].StolenBasePercent2019,
            FWAR2019: this.context.state.designatedHitters[foundIndex].FWAR2019,
            SteamerPAProjection: this.context.state.designatedHitters[foundIndex].SteamerPAProjection,
            SteamerAVGProjection: this.context.state.designatedHitters[foundIndex].SteamerAVGProjection,
            SteamerOBPProjection: this.context.state.designatedHitters[foundIndex].SteamerOBPProjection,
            SteamerSLGProjection: this.context.state.designatedHitters[foundIndex].SteamerSLGProjection,
            SteamerDoublesProjection: this.context.state.designatedHitters[foundIndex].SteamerDoublesProjection,
            SteamerHRProjection: this.context.state.designatedHitters[foundIndex].SteamerHRProjection,
            SteamerRunsProjection: this.context.state.designatedHitters[foundIndex].SteamerRunsProjection,
            SteamerRBIProjection: this.context.state.designatedHitters[foundIndex].SteamerRBIProjection,
            SteamerSBProjection: this.context.state.designatedHitters[foundIndex].SteamerSBProjection,
            SteamerFWARProjection: this.context.state.designatedHitters[foundIndex].SteamerFWARProjection,
        })
    }
