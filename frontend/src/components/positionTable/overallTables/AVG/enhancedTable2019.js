...
function createData(
    ...
    return { name, primaryPosition, otherPositions, PAs, AVG, HR, Runs, RBIs, SBs, PAVG, InningsPitched, QualityStarts, RawKs, ERA, WHIP, Saves, PTotal, score, id, index };
}
        ...
        if (props.players.length !== 0) {
            setRows(props.players.map((player, index) => (
                createData(
                    ...
                    player.PA2019,
                    Number(player.BA2019),
                    player.HR2019,
                    player.Runs2019,
                    player.RBI2019,
                    player.StolenBases2019,
                    (1.75 * (player.Runs2019 + player.RBI2019) + 5.65 * player.HR2019 + 6 * player.StolenBases2019 + (4 * player.PA2019 * (player.BA2019 - 0.250))) / 6,
                    ...
                    ((1.75 * (player.Runs2019 + player.RBI2019) + 5.65 * player.HR2019 + 6 * player.StolenBases2019 + (4 * player.PA2019 * (player.BA2019 - 0.250))) / 6) + ((10 * player.QS2019 +
                        1.2 * player.RawKs2019 +
                        9 * player.Saves2019 +
                        (4 * Number(player.InningsPitched2019) * Number(1.32 - player.WHIP2019)) +
                        Number(player.InningsPitched2019) * Number(4.47 - player.ERA2019)) / 10),
