        ...
        if (props.players.length !== 0) {
            setRows(props.players.map((player, index) => (
                createData(
                    ...
                    player.PA2018,
                    Number(player.BA2018),
                    player.HR2018,
                    player.Runs2018,
                    player.RBI2018,
                    player.StolenBases2018,
                    (1.75 * (player.Runs2018 + player.RBI2018) + 5.65 * player.HR2018 + 6 * player.StolenBases2018 + (4 * player.PA2018 * (player.BA2018 - 0.250))) / 6,
                    Number(player.InningsPitched2018),
                    Number(player.QS2018),
                    player.RawKs2018,
                    Number(player.ERA2018),
                    Number(player.WHIP2018),
                    player.Saves2018,
                    (10 * player.QS2018 +
                        1.2 * player.RawKs2018 +
                        9 * player.Saves2018 +
                        (4 * Number(player.InningsPitched2018) * Number(1.32 - player.WHIP2018)) +
                        Number(player.InningsPitched2018) * Number(4.47 - player.ERA2018)) / 10,
                    ((1.75 * (player.Runs2018 + player.RBI2018) + 5.65 * player.HR2018 + 6 * player.StolenBases2018 + (4 * player.PA2018 * (player.BA2018 - 0.250))) / 6) + ((10 * player.QS2018 +
                        1.2 * player.RawKs2018 +
                        9 * player.Saves2018 +
                        (4 * Number(player.InningsPitched2018) * Number(1.32 - player.WHIP2018)) +
                        Number(player.InningsPitched2018) * Number(4.47 - player.ERA2018)) / 10),
