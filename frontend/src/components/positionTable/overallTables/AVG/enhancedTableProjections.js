...
function createData(
    ...
    return { name, primaryPosition, otherPositions, PAs, AVG, HR, Runs, RBIs, SBs, PAVG, InningsPitched, QualityStarts, RawKs, ERA, WHIP, Saves, PTotal, score, FWAR, id, index };
}
                ...
                props.players.map((player, index) =>
                    createData(
                        ...
                        (1.71 * (player.TheBatXRunsProjection + player.TheBatXRBIProjection) +
                            ...
                            4 * player.TheBatXPAProjection * (player.TheBatXAVGProjection - 0.245)) /
                            6,
                        ...
                        Number(player.TheBatInningsPitchedProjection) * Number(4.43 - player.TheBatERAProjection)) / 8.2,
                        ((1.71 * (player.TheBatXRunsProjection + player.TheBatXRBIProjection) +
                        5.75 * player.TheBatXHRProjection +
                        8.85 * player.TheBatXSBProjection +
                        4 * player.TheBatXPAProjection * (player.TheBatXAVGProjection - 0.245)) /
