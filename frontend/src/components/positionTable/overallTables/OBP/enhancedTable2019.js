...
function createData(name, primaryPosition, otherPositions, PAs, OBP, HR, Runs, RBIs, SBs, POBP, InningsPitched, QualityStarts, RawKs, ERA, WHIP, Saves, PTotal, score, id, index) {
            ...
            setRows(
                props.players.map((player, index) =>
                    createData(
                        ...
                        player.PA2019,
                        Number(player.OBP2019),
                        player.HR2019,
                        player.Runs2019,
                        player.RBI2019,
                        player.StolenBases2019,
                        (1.75 * (player.Runs2019 + player.RBI2019) + 5.65 * player.HR2019 + 6 * player.StolenBases2019 + (4 * player.PA2019 * (player.OBP2019 - 0.32))) / 6,
                        Number(player.InningsPitched2019),
                        Number(player.QS2019),
                        player.RawKs2019,
                        Number(player.ERA2019),
                        Number(player.WHIP2019),
                        player.Saves2019,
                        (10 * player.QS2019 +
                            1.2 * player.RawKs2019 +
                            9 * player.Saves2019 +
                            (4 * Number(player.InningsPitched2019) * Number(1.32 - player.WHIP2019)) +
                            Number(player.InningsPitched2019) * Number(4.47 - player.ERA2019)) / 10,
                        ((1.75 * (player.Runs2019 + player.RBI2019) + 5.65 * player.HR2019 + 6 * player.StolenBases2019 + (4 * player.PA2019 * (player.OBP2019 - 0.32))) / 6) + ((10 * player.QS2019 +
                            1.2 * player.RawKs2019 +
                            9 * player.Saves2019 +
                            (4 * Number(player.InningsPitched2019) * Number(1.32 - player.WHIP2019)) +
                            Number(player.InningsPitched2019) * Number(4.47 - player.ERA2019)) / 10),
