...
class ReliefPitchers extends React.Component {
    ...
    componentDidMount() {
        if (this.context.state.reliefPitchers === []) {
    ...
    render() {
        ...
        const data = (
            <div className={classes.dataDiv}>
                {display2017 ? (
                    <div>
                        <EnhancedPitcherTable2017 players={this.state.reliefPitchers} />
                    </div>
                ) : null}

                {display2018 ? (
                    <div>
                        <EnhancedPitcherTable2018 players={this.state.reliefPitchers} />
                    </div>
                ) : null}

                {display2019 ? (
                    <div>
                        <EnhancedPitcherTable2019 players={this.state.reliefPitchers} />
                    </div>
                ) : null}

                {display2020 ? (
                    <div>
                        <EnhancedPitcherTable2020 players={this.state.reliefPitchers} />
                    </div>
                ) : null}
                ...
                {displayProjections ? (
                    <div>
                        ...
                        <EnhancedPitcherTableProjections players={this.state.reliefPitchers} />
                    </div>
                ) : null}
            </div>
        );
