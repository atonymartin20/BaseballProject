...
import EnhancedTable2020 from '../positionTable/firstBase/enhancedTable2020.js';
import EnhancedTable2019 from '../positionTable/firstBase/enhancedTable2019.js';
import EnhancedTable2018 from '../positionTable/firstBase/enhancedTable2018.js';
import EnhancedTable2017 from '../positionTable/firstBase/enhancedTable2017.js';
...
class FirstBase extends React.Component {
    state = {
        display2017: false,
        display2018: false,
        display2019: false,
    ...
    render() {
        ...
        const data = (
            <div className={classes.dataDiv}>
                ...
                {display2020 ? (
                    <div>
                        <h1 className={classes.positionText}>2020 Projected Stats from <a href="https://www.fangraphs.com/projections.aspx?pos=all&stats=bat&type=steamer&team=0&lg=all&players=0" className={classes.websiteLinks} target='_blank' rel="noopener noreferrer">Steamer</a>.  Last Updated 2/16/2020.</h1>
                        <EnhancedTable2020
                            players={this.state.firstBase}
                        />
                    </div>) : null
...
FirstBase.contextType = AppContext;

export default withStyles(styles)(FirstBase);