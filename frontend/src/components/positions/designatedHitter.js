    ...
    render() {
        ...
        const data = (
            <div className={classes.dataDiv}>
                {display2017 ? (
                    <div>
                        <EnhancedTable2017 players={this.state.designatedHitters} />
                    </div>
                ) : null}

                {display2018 ? (
                    <div>
                        <EnhancedTable2018 players={this.state.designatedHitters} />
                    </div>
                ) : null}

                {display2019 ? (
                    <div>
                        <EnhancedTable2019 players={this.state.designatedHitters} />
                    </div>
                ) : null}

                {display2020 ? (
                    <div>
                        <EnhancedTable2020 players={this.state.designatedHitters} />
                    </div>
                ) : null}

                {display2021 ? (
                    <div>
                        <EnhancedTable2021 players={this.state.designatedHitters} />
                    </div>
                ) : null}
                ...
                {displayProjections ? (
                    <div>
                        ...
                        <EnhancedTableProjections players={this.state.designatedHitters} />
                    </div>
                ) : null}
            </div>
        );
