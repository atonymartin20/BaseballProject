...
class CornerInfield extends React.Component {
    state = {
        display2017: false,
        display2018: false,
        display2019: false,
    ...
    componentDidMount() {
        if (this.context.state.cornerInfield === []) {
    ...
    render() {
        ...
        const data = (
            <div className={classes.dataDiv}>
                {display2017 ? (
                    <div>
                        <EnhancedTable2017 players={this.state.cornerInfield} />
                    </div>
                ) : null}

                {display2018 ? (
                    <div>
                        <EnhancedTable2018 players={this.state.cornerInfield} />
                    </div>
                ) : null}

                {display2019 ? (
                    <div>
                        <EnhancedTable2019 players={this.state.cornerInfield} />
                    </div>
                ) : null}

                {display2020 ? (
                    <div>
                        <EnhancedTable2020 players={this.state.cornerInfield} />
                    </div>
                ) : null}

                {display2021 ? (
                    <div>
                        <EnhancedTable2021 players={this.state.cornerInfield} />
                    </div>
                ) : null}
                ...
                {displayProjections ? (
                    <div>
                        <h1 className={classes.positionText}>
                            ...
                            >
                                The Bat X
                            </a>. Last Update: 2/11/2022
                        </h1>
                        <EnhancedTableProjections players={this.state.cornerInfield} />
                    </div>
                ) : null}
            </div>
        );
...
CornerInfield.contextType = AppContext;

export default withStyles(styles)(CornerInfield);